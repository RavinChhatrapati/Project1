...
attributes ={}
  attributes[:title] = movie_info.css("h2.body-text__paragraph-header.font--h2").text
movie_info.css("p.body-text__paragraph-text.font--body.has-spacing").each do |movie_details|
#attributes[:released] = movie_details.css()
